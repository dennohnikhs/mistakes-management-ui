    ...
    <div>
      <div className="text-pa-white bg-pa-black py-3 px-3 mt-5 lg:w-[400px]">
        <div className="gap-2 py-3 pb-4 w-full text-center items-center ">
          <h1>Fill Offense details...</h1>
        </div>
        <div className="flex flex-col gap-3 text-pa-black ">
          <input
            type="text"
            className="py-3 px-4 "
            placeholder="offense_type_id"
          />
          <input type="text" className="py-3 px-4" placeholder="student_id" />
          <input type="text" className="py-3 px-4" placeholder="comments" />
        </div>
