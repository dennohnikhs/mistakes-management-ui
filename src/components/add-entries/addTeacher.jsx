    ...
    <div>
      <div className="text-pa-white bg-pa-black py-3 px-3 mt-5 lg:w-[400px]">
        ...
        <div className="flex flex-col gap-3 text-pa-black ">
          <input type="text" className="py-3 px-4 " placeholder="name" />
          <input type="text" className="py-3 px-4" placeholder="phone_number" />
          <input type="text" className="py-3 px-4" placeholder="email" />
          <input type="text" className="py-3 px-4" placeholder="password" />
          <input type="text" className="py-3 px-4" placeholder="role" />
        </div>
